...
${retrievedContext ? `\nReference Knowledge (retrieved from a curated interview Q&A bank and prep guides — use this to ground your questions and preparation plan in realistic, role-specific material, but do not copy it verbatim and do not mention that it was retrieved):\n${retrievedContext}\n` : ""}
